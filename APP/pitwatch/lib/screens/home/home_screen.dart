...
import 'package:pitwatch/screens/drowsiness/eye_monitoring_screen.dart';
import 'package:pitwatch/screens/session/session_screen.dart';
import 'package:pitwatch/screens/home/nearby_potholes.dart';
import 'package:pitwatch/screens/drowsiness/drowsiness_alert_screen.dart';
...
class _HomeScreenState extends ConsumerState<HomeScreen> with RouteAware {
  ...
  Widget build(BuildContext context) {
    ...
    // For now use the persisted total detections count in both slots
    final total = ref.watch(totalDetectionsProvider);
    final last30 = total;
    final localTotal = total;
